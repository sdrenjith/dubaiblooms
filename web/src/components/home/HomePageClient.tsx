...
type Props = {
  ...
  categoryStories: Record<string, Article[]>;
};
...
export function HomePageClient({ featured, latest, settings, categoryStories }: Props) {
  ...
  }, [useStaticHero, staticHeroImage, activeSlide, featured, latest, leadStory]);
        ...
        <div className="hero-copy">
          {useStaticHero ? (
            <>
              ...
              {staticLink.external ? (
                <a className="button-link feature-spotlight-btn" href={staticLink.href} target="_blank" rel="noreferrer">
                  {staticBtn}
                </a>
              ) : (
                <Link className="button-link feature-spotlight-btn" href={staticLink.href}>
                  {staticBtn}
                </Link>
              )}
            ...
            <>
              ...
              <Link
                ...
                href={leadStory ? `/${leadStory.category?.slug || 'story'}/${leadStory.slug}` : '/'}
              >
                Read full story
              </Link>
        ...
        <section className="category-strip-wrap" aria-labelledby="category-topics-heading">
          ...
          <div className="category-strip">
            {categoryTiles.map((tile, index) => (
              <Link key={tile.slug} className="category-pill" href={`/${tile.slug}`}>
                ...
                <div className="list">
                  ...
                  {sectionStories.map((item) => (
                    <article key={item._id} className="list-item">
                      <Link className="list-item-link" href={`/${item.category?.slug || 'story'}/${item.slug}`}>
                        <div className="list-item-copy">
